...
namespace ValecnaPlaneta.Migrations
{
    ...
    [Migration("20230608073642_UpravaVlastnikaPolicek")]
    partial class UpravaVlastnikaPolicek
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ValecnaPlaneta.Models.Policko", b =>
                {
                    ...
                    b.HasOne("ValecnaPlaneta.Models.Hrac", "Vlastnik")
                        .WithMany()
                        .HasForeignKey("VlastnikId");

                    b.Navigation("HraKamPatri");

                    b.Navigation("Vlastnik");
                });
